...
class PrimitivesTest extends AnyFlatSpec with Matchers with MockFactory with ScalaCheckPropertyChecks {
  ...
  "booleanDecoder" should "return a true value from scalar" in
    (caseIterator("true") ++ caseIterator("on") ++ caseIterator("yes")).foreach { value =>
      booleanDecoder(Node.Scalar(Id.Root, value, Tag.None(mock[Location]), mock[Location])) shouldBe true.valid
    }

  it should "return a false value from scalar" in
    (caseIterator("false") ++ caseIterator("off") ++ caseIterator("no")).foreach { value =>
      booleanDecoder(Node.Scalar(Id.Root, value, Tag.None(mock[Location]), mock[Location])) shouldBe false.valid
    }

  it should "return an error from non-boolean scalar" in {
    val nonEmptyNode = Node.Scalar(Id.Root, "non-boolean", Tag.None(mock[Location]), mock[Location])
  ...
  "byteDecoder" should "return a byte value from scalar" in
    forAll { (value: Byte) =>
      byteDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }

  it should "return an error for out of bounds values" in {
    val positiveNode =
      Node.Scalar(Id.Root, (Byte.MaxValue.toLong + 1).toString, Tag.None(mock[Location]), mock[Location])
    Decoder[Byte](positiveNode) should matchPattern {
      case Validated.Invalid(Decoder.Thrown(`positiveNode`, _: NumberFormatException)) =>
    }
    val negativeNode =
      Node.Scalar(Id.Root, (Byte.MinValue.toLong - 1).toString, Tag.None(mock[Location]), mock[Location])
  ...
  "shortDecoder" should "return a short value from scalar" in
    forAll { (value: Short) =>
      shortDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }

  it should "return an error for out of bounds values" in {
    val positiveNode =
      Node.Scalar(Id.Root, (Short.MaxValue.toLong + 1).toString, Tag.None(mock[Location]), mock[Location])
    Decoder[Short](positiveNode) should matchPattern {
      case Validated.Invalid(Decoder.Thrown(`positiveNode`, _: NumberFormatException)) =>
    }
    val negativeNode =
      Node.Scalar(Id.Root, (Short.MinValue.toLong - 1).toString, Tag.None(mock[Location]), mock[Location])
  ...
  "intDecoder" should "return an integer value from scalar" in
    forAll { (value: Int) =>
      intDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }

  it should "return an error for out of bounds values" in {
    val positiveNode =
      Node.Scalar(Id.Root, (Int.MaxValue.toLong + 1).toString, Tag.None(mock[Location]), mock[Location])
    Decoder[Int](positiveNode) should matchPattern {
      case Validated.Invalid(Decoder.Thrown(`positiveNode`, _: NumberFormatException)) =>
    }
    val negativeNode =
      Node.Scalar(Id.Root, (Int.MinValue.toLong - 1).toString, Tag.None(mock[Location]), mock[Location])
  ...
  "longDecoder" should "return a long value from scalar" in
    forAll { (value: Long) =>
      longDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }
  ...
  it should "return an error for out of bounds values" in {
    val positiveNode =
      Node.Scalar(Id.Root, (BigInt(Long.MaxValue) + BigIntOne).toString, Tag.None(mock[Location]), mock[Location])
    Decoder[Long](positiveNode) should matchPattern {
      case Validated.Invalid(Decoder.Thrown(`positiveNode`, _: NumberFormatException)) =>
    }
    val negativeNode =
      Node.Scalar(Id.Root, (BigInt(Long.MinValue) - BigIntOne).toString, Tag.None(mock[Location]), mock[Location])
  ...
  "floatDecoder" should "return a floating point value from scalar" in {
    forAll { (value: Float) =>
      floatDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }
    floatDecoder(Node.Scalar(Id.Root, Double.MaxValue.toString, Tag.None(mock[Location]), mock[Location])) shouldBe
      Float.PositiveInfinity.valid
    floatDecoder(Node.Scalar(Id.Root, Double.MinValue.toString, Tag.None(mock[Location]), mock[Location])) shouldBe
  ...
  "doubleDecoder" should "return a double precision floating point value from scalar" in {
    forAll { (value: Double) =>
      doubleDecoder(Node.Scalar(Id.Root, value.toString, Tag.None(mock[Location]), mock[Location])) shouldBe value.valid
    }
    doubleDecoder(
      Node.Scalar(Id.Root, (BigDecimal(Double.MaxValue) * BigDecimalTwo).toString, Tag.None(mock[Location]),
        mock[Location])) shouldBe Double.PositiveInfinity.valid
    doubleDecoder(
      Node.Scalar(Id.Root, (BigDecimal(Double.MinValue) * BigDecimalTwo).toString, Tag.None(mock[Location]),
